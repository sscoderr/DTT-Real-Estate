...
class ListViewWidget extends StatelessWidget {
  ...
  const ListViewWidget(
      {super.key, required this.houseList, required this.searchText, required this.distanceCanBeVisible});

  Future<List<House>> filterHouseList() async {
    ...
    if (searchText.isEmpty) {
      ...
      return houseList.where((house) {
        ...
        List<String> searchTextArr = searchText.toLowerCase().split(
            RegExp(r'(?<=\D)\s'));
    ...
    return FutureBuilder<List<House>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            List<House> filteredHouseList = snapshot.data!;
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(builder: (context) =>
                            DetailsPage(selectedItem: house, distance: house
                                .distance.toString())),
                      );
                    },
                    child: Padding(
                      padding: EdgeInsets.symmetric(
                          vertical: 0.75.h, horizontal: 4.2.w),
                      child: Container(
